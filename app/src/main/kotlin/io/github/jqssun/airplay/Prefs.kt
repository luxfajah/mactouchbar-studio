...
object Prefs {
    ...
    const val SERVER_NAME = "server_name"; const val DEF_SERVER_NAME = "Samsung DeX Display"
    ...
    const val RESOLUTION = "resolution"; const val DEF_RESOLUTION = "3840x2160" // HighDpi 4K UHD Default
